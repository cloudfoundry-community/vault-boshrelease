...
Pipeline running at http://ci.starkandwayne.com:8080/pipelines/vault-boshrelease

Setup pipeline in Concourse
---------------------------

```
fly -t snw c -c pipeline.yml --vars-from credentials.yml vault-boshrelease --paused=false
```
...
fly -t snw configure \
  ...
  vault-boshrelease-image --paused=false
```
